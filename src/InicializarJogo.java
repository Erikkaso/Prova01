...
public class InicializarJogo {
	...
	public InicializarJogo() {
		...
		planetas.add(new Java(p));
		planetas.add(new Python(p));
		planetas.add(new JavaScript(p));
		planetas.add(new RubyOnRails(p));
		planetas.add(new Php(p));
		planetas.add(new CSharp(p));
		planetas.add(new CPlus(p));
		planetas.add(new C(p));
